...
const cacheName = 'fixit7SecondExtraXPKyle-2020-11-23 17:24:19.060687'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'fixit7SecondExtraXPKyle'.length) === 'fixit7SecondExtraXPKyle') {
